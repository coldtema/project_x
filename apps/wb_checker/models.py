...
class WBProduct(models.Model):
    ...
    enabled_authors = models.ManyToManyField(Author, verbose_name='Никнеймы авторов', related_name='enabled_authors')
    disabled_authors = models.ManyToManyField(Author, verbose_name='Никнеймы авторов (нет в наличии)', related_name='disabled_authors')
